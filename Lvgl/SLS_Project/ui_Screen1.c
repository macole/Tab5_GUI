...
lv_obj_t *ui_Screen1 = NULL;lv_obj_t *ui_Arc1 = NULL;lv_obj_t *ui_Label1 = NULL;lv_obj_t *ui_Button1 = NULL;lv_obj_t *ui_Label2 = NULL;lv_obj_t *ui_Label3 = NULL;lv_obj_t *ui_Spinner2 = NULL;lv_obj_t *ui_Slider1 = NULL;lv_obj_t *ui_Label4 = NULL;
// event funtions
...
lv_obj_set_x( ui_Slider1, 398 );
lv_obj_set_y( ui_Slider1, -46 );
