...
void create_screen_main() {
    ...
    lv_obj_set_size(obj, 1280, 720);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_label_set_text(obj, "CanvasDrawing");
        }
        {
            // Button1
            lv_obj_t *obj = lv_btn_create(parent_obj);
            objects.button1 = obj;
            lv_obj_set_pos(obj, 47, 55);
        ...
        }
        {
            ...
            objects.canvas1 = obj;
            lv_obj_set_pos(obj, 271, 25);
            lv_obj_set_size(obj, 991, 676);
...
static const char *object_names[] = { "main", "button1", "canvas1" };
